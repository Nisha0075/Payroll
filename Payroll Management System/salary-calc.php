        ...
        <div class="row align-items-center h-100" >
          ...
          <div class="col-8 mx-auto">
                ...
                <div class="shadow-lg bg-white mt-4">
                    ...
                    <form action="salary-calc-action.php" method="post">
                        <div class="form-group mx-4 mt-4">
                            <input type="text" name="empid" required class="form-control" placeholder="Employee ID">
                        </div>
                        <div class="form-group mx-4 mt-4">
                            <input type="number" name="leave" required class="form-control" placeholder="No of Leave">
                        </div>
                        <div class="form-group mx-4 mt-4">
                        ...
                        <button type="submit" class="btn login-btn btn-block my-4">Calculate</button>
                    </form>
                </div>
